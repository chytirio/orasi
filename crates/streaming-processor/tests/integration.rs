...
use streaming_processor::{
    processors::{
        StreamProcessor, FilterProcessor, TransformProcessor, AggregateProcessor, ProcessorPipeline,
        stream_processor::StreamProcessorConfig,
        filter_processor::{FilterProcessorConfig, FilterMode, FilterRule, FilterOperator},
        transform_processor::TransformProcessorConfig,
        aggregate_processor::AggregateProcessorConfig,
    },
    arrow_utils::{serialize_to_arrow_ipc, deserialize_from_arrow_ipc},
};
use bridge_core::{
    traits::DataStream,
...
async fn test_end_to_end_pipeline() {
    ...
    let filter_config = FilterProcessorConfig::new(vec![create_test_filter_rule()], FilterMode::Include);

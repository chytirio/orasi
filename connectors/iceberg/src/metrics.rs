...
/// Apache Iceberg metrics collector
#[derive(Debug, Clone)]
...
impl IcebergMetrics {
    ...
    pub fn get_snapshot(&self) -> IcebergMetricsSnapshot {
...
/// Apache Iceberg metrics snapshot
...
/// Apache Iceberg metrics manager
pub struct IcebergMetricsManager {
    /// Metrics collector
    metrics: IcebergMetrics,
}

impl IcebergMetricsManager {
    /// Create a new metrics manager
    pub fn new() -> Self {
        Self {
            metrics: IcebergMetrics::new(),
        }
    }

    /// Get the metrics collector
    pub fn metrics(&self) -> &IcebergMetrics {
        &self.metrics
    }
...
iceberg_total_writes {total_writes}

# HELP iceberg_total_reads Total number of read operations
# TYPE iceberg_total_reads counter
iceberg_total_reads {total_reads}

# HELP iceberg_total_records_written Total number of records written
# TYPE iceberg_total_records_written counter
iceberg_total_records_written {total_records_written}

# HELP iceberg_total_records_read Total number of records read
# TYPE iceberg_total_records_read counter
iceberg_total_records_read {total_records_read}

# HELP iceberg_total_bytes_written Total bytes written
# TYPE iceberg_total_bytes_written counter
iceberg_total_bytes_written {total_bytes_written}

# HELP iceberg_total_bytes_read Total bytes read
# TYPE iceberg_total_bytes_read counter
iceberg_total_bytes_read {total_bytes_read}

# HELP iceberg_write_errors Total write errors
# TYPE iceberg_write_errors counter
iceberg_write_errors {write_errors}

# HELP iceberg_read_errors Total read errors
# TYPE iceberg_read_errors counter
iceberg_read_errors {read_errors}

# HELP iceberg_avg_write_time_ms Average write time in milliseconds
# TYPE iceberg_avg_write_time_ms gauge
iceberg_avg_write_time_ms {avg_write_time_ms}

# HELP iceberg_avg_read_time_ms Average read time in milliseconds
# TYPE iceberg_avg_read_time_ms gauge
iceberg_avg_read_time_ms {avg_read_time_ms}
"#,
...
impl Default for IcebergMetricsManager {
    fn default() -> Self {
        Self::new()
    }
}

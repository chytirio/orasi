...
use streaming_processor::sinks::file_sink::{FileFormat, FileSinkConfig, WriteMode};
...
async fn main() -> BridgeResult<()> {
    ...
    let config = FileSinkConfig::new("output/telemetry_data.json".to_string(), FileFormat::Json);

...
impl MetricsCollector for InMemoryMetricsCollector {
    ...
    async fn record_metrics(&self, metrics: StreamMetrics) -> BridgeResult<()> {
        ...
        // Update stats
        {
            ...
            stats.avg_collection_time_ms = stats.total_collection_time_ms as f64 / stats.total_metrics as f64;
...
impl MetricsManager {
    ...
    pub async fn record_metrics(&self, metrics: StreamMetrics) -> BridgeResult<Vec<BridgeResult<()>>> {
...
impl MetricsFactory {
    ...
    pub fn create_collector(collector_type: &str, name: String) -> Option<Box<dyn MetricsCollector>> {

use bridge_core::{
    ...
    traits::exporter::LakehouseExporter,
    types::{
        traces::SpanKind, traces::SpanStatus, traces::StatusCode, traces::TraceData,
        ProcessedBatch, ProcessedRecord, ProcessingStatus, TelemetryData,
    },
    BridgeResult,
};
use chrono::Utc;
...
async fn main() -> BridgeResult<()> {
    ...
    if let Ok(entries) = std::fs::read_dir(delta_base_path) {

...
#[openapi(
    paths(
        crate::handlers::health_live_handler,
        crate::handlers::health_ready_handler,
        crate::handlers::get_status_handler,
        crate::handlers::ingest_traces_handler,
        crate::handlers::ingest_metrics_handler,
        crate::handlers::ingest_logs_handler,
        crate::handlers::ingest_batch_handler,
        crate::handlers::query_metrics_handler,
        crate::handlers::query_traces_handler,
        crate::handlers::query_logs_handler,
        crate::handlers::query_analytics_handler,
    ),
    components(
        schemas(
